...
excerpt: "Parallel Transport Tractography (PTT) is a probabilistic tracking algorithm that frames fiber propagation as a curve evolving along a parallel transport frame. Compared to simpler deterministic methods, PTT better handles fiber crossings and produces smoother streamlines."
tags:
  - Neuroimaging
  - DIPY
  - Tractography
